...
import { getCurrencies, KeyValuePair, updateTypesIds } from "@gms-micro/api-utils";
...
const FormConditionalFields = ({ updateTypeId, errors }: FormConditionalFieldsProps) => {
    return (
        <>
            {(updateTypesIds.periodUpdateTypes.includes(updateTypeId) || updateTypesIds.workAccidentUpdateTypes.includes(updateTypeId)) &&
