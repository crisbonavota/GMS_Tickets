...
const App = () => {
    ...
    const filters = useMemo(() => [
        ...
        { field: 'legacyUserId_OR', value: users.length ? users.join(',') : undefined },
        { field: 'legacyUser.businessUnitId_OR', value: businessUnits.length ? businessUnits.join(',') : undefined },
        { field: 'projectId_OR', value: projects.length ? projects.join(',') : undefined },
        { field: 'project.proposalId_OR', value: proposals.length ? proposals.join(',') : undefined },
        { field: 'project.proposal.accountId_OR', value: accounts.length ? accounts.join(',') : undefined },
                ...
                <VStack w={'full'} spacing={5} alignItems={'flex-start'}>
                    ...
                    <SelectFilters
                        ...
                        dropdownsData={[
                            ...
                            { labelOption: 'name', valueOption: 'id', values: projects, setValue: setProjects, title: "Project", resource: 'projects' },
                            { labelOption: 'name', valueOption: 'id', values: proposals, setValue: setProposals, title: "Proposal", resource: 'proposals' },
