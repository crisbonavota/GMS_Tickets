...
export const putResource = async (resource: string, id: number, authHeader: string, data: KeyValuePair) => {
    return await client.put(`/${resource}/${id}`, data, { headers: { Authorization: authHeader } });
}
